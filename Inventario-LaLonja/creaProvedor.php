            ...
            <div class="container px-5 my-5 px-5">
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <!-- to get an API token!-->
                        <form id="contactForm"  method="post" action="provedores.php" data-sb-form-api-token="API_TOKEN">
                            <!-- Name input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" type="text" placeholder="Enter your name..." data-sb-validations="required" />
                                <label for="name">Nombre provedor</label>
                                <div class="invalid-feedback" data-sb-feedback="name:required">El provedor es requerido</div>
                            </div>
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="phone:required">Escribe bien el numero</div>
                            </div>
                            <!-- Message input-->
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="message" type="text" placeholder="Enter your message here..." style="height: 10rem" data-sb-validations="required"></textarea>
                                <label for="message">Direccion</label>
                                <div class="invalid-feedback" data-sb-feedback="message:required">Escribe la direccion</div>
                            </div>
